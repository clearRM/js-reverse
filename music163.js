      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        le7X: function(a) {
            var c = this.i3x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Gc2x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createDecryptor: function(e, a) {
            return this.create(this.bql3x, e, a)
        },
        init: function(e, a, b) {
    ...
    d.BlockCipher = v.extend({
        ...
        reset: function() {
            ...
            var a = this.cfg
              , b = a.iv
              , a = a.mode;
            if (this.TB7u == this.Gb2x)
                var c = a.createEncryptor;
            else
                c = a.createDecryptor,
                this.Gc2x = 1;
            this.eO5T = c.call(a, this, b && b.words)
        },
        rl9c: function(a, b) {
            this.eO5T.processBlock(a, b)
        },
        mF7y: function() {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        ll7e: function() {
            for (var a = this.J3x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bgu0x = d + 6) + 1), e = this.bqC3x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.FA2x(a, b, this.bqC3x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.FA2x(a, c, this.bqH3x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        FA2x: function(a, b, c, d, e, j, l, f) {
            for (var m = this.bgu0x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function start() {
    ...
    var bVV0x = asrsea(JSON.stringify(d), e, f, g);
    return bVV0x
}


// d: "{"rid":"R_SO_4_1457757260",e,f,"csrf_token":""}" 歌曲的id
// d: "{"rid":"R_SO_4_501928179","offset":"40","total":"false","limit":"20","csrf_token":""}"
// d: "{"rid":"R_SO_4_501928179","offset":"100","total":"false","limit":"20","csrf_token":""}"
// e: "010001"
